        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-8 items-center">
          ...
          <div className="flex flex-col gap-6 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-4">
              ...
              <button className="flex h-12 min-w-[160px] items-center justify-center rounded-lg border border-gray-700 bg-slate-800/50 hover:bg-slate-800 text-white px-6 text-base font-bold transition-all backdrop-blur-sm">
                <svg
            ...
            <div className="relative z-10 rounded-xl bg-[#1e293b] p-2 shadow-2xl ring-1 ring-white/10 transition-transform hover:scale-[1.02] duration-700 ease-out group">
              ...
              <div className="aspect-[3/4] w-full overflow-hidden rounded-lg bg-gradient-to-br from-slate-800 to-slate-900 border border-gray-700/50 relative">
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="h-2 w-48 bg-white/60 rounded"></div>
                  <div className="h-2 w-40 bg-white/60 rounded"></div>
